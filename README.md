...
3. Download project from github(https://github.com/Abinash-01/Blood-Bank-and-Donation-Management-System.git).
   ...
   OR follow gitbash commands <br>
     ```t
         i>cd C:\\xampp\htdocs\
        ii>git clone https://github.com/Abinash-01/Blood-Bank-and-Donation-Management-System.git
...
9. Browse the file in directory[Blood-Bank-And-Donation-Management-System/sql/blood_bank_database.sql].
...
<br><b>1. Home Page 
   <br>
   <img src="<h3> User Panel Images </h3>
<br><b>1. Home Page 
   <br>
